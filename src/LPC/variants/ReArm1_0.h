...
const uint32_t STEP_DRIVER_MASK =           0xFFFFFEF0; //SD: mask of the step pins on Port 2 used for writing to step pins in parallel (0's indicate which bits to set)
