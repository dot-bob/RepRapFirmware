...
//Main RepRap Modules
#define PLATFORM_RAM                RAM1       //(1164 Bytes)
#define NETWORK_RAM                 RAM1
#define GCODES_RAM                  RAM0       //(1012 Bytes)
#define MOVE_RAM                    RAM0       //(1256 Bytes)
#define HEAT_RAM                    RAM0       //(128 Bytes)
#define PM_RAM                      RAM0       //PrintMonitor RAM (660 Bytes)
...
//Platform objects
#define AUXOUT_RAM                  /*RAM1*/   //Aux OutputStack (24 Bytes)
#define USBOUT_RAM                  /*RAM1*/   //USB OutputStack (24 Bytes)
#define MS_RAM                      RAM0   //Mass Storage (6932 Bytes)
#define FILEWRITEBUFFER                    // File WRite Buffer for Mass Storage (?? Bytes)
#define LOG_RAM                     /*RAM1*/   //Logger (24 Bytes)
